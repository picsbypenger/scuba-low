              ...
              <div className="mb-6 bg-gray-50 p-4 sm:p-6 rounded-xl border border-gray-100">
                <form onSubmit={handleCreateCourse} className="flex flex-col sm:flex-row flex-wrap gap-4">
                  ...
                  <button
                    type="submit"
                    disabled={submitting || Boolean(selectedCourseId)}
                    className={`w-full sm:w-auto bg-blue-600 justify-center text-white px-6 py-3 rounded-xl font-bold flex items-center hover:bg-blue-700 transition shadow-lg active:scale-95 disabled:opacity-50 ${selectedCourseId ? 'opacity-60 cursor-not-allowed' : ''}`}
                  >
                    {submitting ? (
                    ...
                    >
                      ...
                      <div className="flex gap-2 w-full mt-auto">
                        <button
                          ...
                          className={`flex-1 py-3 sm:py-2 rounded-lg text-[10px] sm:text-xs font-black uppercase tracking-widest transition ${selectedCourseId === course.id ? 'bg-rust text-white shadow-md' : 'bg-gray-100 text-gray-500 hover:bg-gray-200'}`}
                        >
                        ...
                        <button
                          ...
                          className="flex-1 py-3 sm:py-2 rounded-lg text-[10px] sm:text-xs font-black uppercase tracking-widest transition bg-rust text-white hover:opacity-90 hover:shadow-sm"
                        >
                          Add Round
                        </button>
                      </div>

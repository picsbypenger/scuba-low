...
const DataManagement = () => {
  ...
  const handleImport = async (e: ChangeEvent<HTMLInputElement>) => {
    ...
    setStatus({
      type: "loading",
      message: "Importing data (this may take a moment)...",
    });
    ...
    reader.onload = async (event) => {
      try {
        ...
        setStatus({
          type: "success",
          message: `Import complete! Restored ${courses?.length || 0} courses and ${rounds?.length || 0} rounds to your account.`,
        });
      } catch (error: any) {
      ...
      <div className="bg-white p-8 rounded-2xl border border-gray-100">
        <div className="flex items-center mb-6">
          ...
          <div>
            ...
            <p className="text-gray-500 text-sm">
              Backup and restore your local golf database
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
          ...
          <div className="p-6 border-2 border-dashed border-gray-200 rounded-xl hover:border-blue-400 transition group">
            ...
            <p className="text-sm text-gray-500 mb-4">
              Download all golfers, courses, and rounds as a JSON file.
            </p>
            <button
              onClick={exportData}
          ...
          <div className="p-6 border-2 border-dashed border-gray-200 rounded-xl hover:border-green-400 transition group relative">
            ...
            <p className="text-sm text-gray-500 mb-4">
              Restore courses and rounds from a backup file.
            </p>
        ...
        {status.type !== "idle" && (
          ...
          >
            ...
            {status.type === "success" && (
              <CheckCircle2 size={20} className="mr-3 mt-0.5" />
            )}
            {status.type === "error" && (
        ...
        <div className="flex">
          ...
          <div className="ml-3">
            <p className="text-sm text-yellow-700">
              <strong>Note:</strong> Imported rounds will be associated with
